...
function ChooseUs() {
  ...
  src={MainImg}
  alt="gear_img"
  style={{ width: "120rem", height: "40rem" }} // Adjust width and height as needed
/>
            ...
            <div className="text-container">
              ...
              <div className="text-container__right">
                <div className="text-container__right__box">
                  <img src={Box1} alt="gear-img" />
                  <div className="text-container__right__box__text">
                    <h4>Cross Country Camping</h4>
                    <p>
                      Take your camping experience to the next level with our
                      top-notch gears for your cross-country adventures.
                    </p>
                  </div>
                </div>
                <div className="text-container__right__box">

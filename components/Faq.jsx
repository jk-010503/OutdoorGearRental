        ...
        <div className="container">
          <div className="faq-content">
            <div className="faq-content__title">
              ...
              <p>
                Frequently Asked Questions About the Gear Rental Booking Process
            ...
            <div className="all-questions">
              <div className="faq-box">
                ...
                >
                  <p>1. What is special about comparing rental gear deals?</p>
                  <IconChevronDown />
                </div>
                <div
                  id="q1"
                ...
                >
                  Comparing rental gear deals is important as it helps find the
                  best deal that fits your budget and requirements, ensuring you
                  get the most value for your money. By comparing various
                  options, you can find deals that offer lower prices,
                  additional services, or better car models. You can find gear
              ...
              <div className="faq-box">
                ...
                >
                  <p>2. How do I find the gear rental deals?</p>
                  <IconChevronDown />{" "}
                </div>
                <div
                  id="q2"
                ...
                >
                  You can find gear rental deals by researching online and
                  ...
                  gear companies on social media to be informed of any special
                  deals or promotions.
                </div>
              </div>
              <div className="faq-box">
                ...
                >
                  <p>3. How do I find such low rental gear prices?</p>
                  <IconChevronDown />
                </div>
                <div
                  id="q3"
                ...
                >
                  Book in advance: Booking your rental gear ahead of time can
                  often result in lower prices. Compare prices from multiple
                  companies: Use websites like Kayak, Expedia, or Travelocity to
                  compare prices from multiple rental gear companies. Look for
